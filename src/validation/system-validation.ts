...
async function validateSystem() {
  ...
  try {
    ...
    try {
      ...
      const settingsCount = await prismaService.systemSetting.count();
      console.log(`✓ SystemSetting model accessible, ${settingsCount} records found`);
    } catch (error) {
    ...
    try {
      ...
      const notificationPrefCount = await prismaService.notificationPreference.count();
      console.log(`✓ NotificationPreference model accessible, ${notificationPrefCount} records found`);
    } catch (error) {
    ...
    try {
      // Test ApiKey model
      const apiKeyCount = await prismaService.apiKey.count();
      console.log(`✓ ApiKey model accessible, ${apiKeyCount} records found`);
    } catch (error) {
