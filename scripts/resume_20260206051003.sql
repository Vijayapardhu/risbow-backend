...
ALTER TYPE "OrderStatus" ADD VALUE IF NOT EXISTS 'OUT_FOR_INSPECTION';
ALTER TYPE "OrderStatus" ADD VALUE IF NOT EXISTS 'RETURN_REQUESTED';
ALTER TYPE "OrderStatus" ADD VALUE IF NOT EXISTS 'QC_IN_PROGRESS';
ALTER TYPE "OrderStatus" ADD VALUE IF NOT EXISTS 'RETURN_PICKED_UP';
...
-- AlterEnum
ALTER TYPE "PaymentIntentPurpose" ADD VALUE IF NOT EXISTS 'VENDOR_GST_COMPLIANCE';
